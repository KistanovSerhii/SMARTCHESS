...
//=================================== multiplexar +++
  ...
  digitalWrite(rfidEN3, HIGH);
  digitalWrite(rfidEN4, LOW); 
...
/*if (!isBtnTimerPressed && btnTimerValue > 700) {
  isBtnTimerPressed = true;
  Serial.println("true");
}
if (isBtnTimerPressed && btnTimerValue == 0) {
  isBtnTimerPressed = false;
  Serial.println("false");
}*/

//Serial.print("btnTimerValue: "); Serial.println(btnTimerValue);
//Serial.print("btnTimerDelayCounter: "); Serial.println(btnTimerDelayCounter);
...
/*
  if (btnTimerValue == 0 && btnTimerDelayCounter > 50) {
    isBtnTimerPressed = false;
    btnTimerDelayCounter = 0;
  }*/
// Timer btn action ---
